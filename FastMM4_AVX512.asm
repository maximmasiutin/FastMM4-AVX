...
; Measurements put the crossover in the same place: rep movsb starts to beat
; other methods at 256 bytes, but the clear benefit over an AVX copy only
; appears above 2048 bytes, which is the bound tested here.
